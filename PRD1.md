...
- [x] **Win detection** — All tiles cleared → celebration screen
- [x] **Stuck detection** — No valid moves → offer shuffle or new game
...
- [x] Layout data for turtle formation
- [x] Board renders all 144 tiles in position
- [x] Basic 3D stacking visual (shadows, overlap)
...
- [x] Free tile detection (not blocked)
- [x] Click to select (highlight free tiles only)
- [x] Match logic (two identical → remove)
- [x] Win detection (all removed)
- [x] Stuck detection (no valid pairs)
- [x] New Game button
- [x] Shuffle button
...
- [x] Title screen with watercolor art
- [x] Win celebration screen
- [x] Visual polish (hover states, smooth transitions)
- [x] Add PWA icons (crop from hydrangea)
- [x] Test full playthrough
- [x] Deploy to Vercel
- [x] Install PWA on Mom's computer
